...
import { Calendar, LayoutDashboard, Database, ClipboardList, Inbox, LogOut, ShieldAlert, Radar, Ticket, Palette } from "lucide-react";
...
export default async function AdminDashboardLayout({
  ...
  const menuItems = [
    ...
    { name: "Brand Lab", href: "/admin/dashboard/brandlab", icon: Palette },
  ];
